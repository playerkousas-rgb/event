...
3. **7 級帳戶權限與職級架構 (7-Level RBAC)**：
   ...
   - 👑 **典禮儀式卡片已內建官方定稿內容**（2026-10-04，不會再改）：典禮程序（10:45 嘉賓接待 → 11:00 吳家麗會長主禮優異旅團頒發 → 12:00 區永樑指揮官主禮會操檢閱 → 13:00 茶聚 → 14:00 主題活動區）及 嘉賓地圖（東閘入口／警校道／有蓋操場報到處／莫榮大樓接待處／海洋公園停車場／穿梭巴士）已直接內建於卡片，毋須連結 Drive。
4. **8 大卡片管理模組**：

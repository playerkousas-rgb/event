...
3. **7 級帳戶權限與職級架構 (7-Level RBAC)**：
   ...
   - ⚠️ **開戶權限**：前端開戶卡片只提供 工作人員／主任／總主任 三級；副主席及以上職級由管理員直接處理（用戶管理／開戶表／批量 CSV）。組別下拉不含 顧問團 及 主席及執行副主席 兩組（不設組卡片）。
   - 📇 **管理資料組卡片 = 部門管理中心卡片數（7 組）**：會操及典禮組、主題節目組、品牌推廣組、嘉賓接待組、協調組、服務及發展組、行政組；財務已歸入行政組卡片。
4. **8 大卡片管理模組**：

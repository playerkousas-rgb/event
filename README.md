...
3. **7 級帳戶權限與職級架構 (7-Level RBAC)**：
   ...
   - 📇 **部門管理中心 = 10 組**（含 顧問團、主席及執行副主席、秘書處，可查看/統計）；**管理資料組卡片 = 8 張**（部門管理中心除顧問及主席之外）：秘書處、會操及典禮組、主題節目組、品牌推廣組、嘉賓接待組、協調組、服務及發展組、行政組；財務已歸入行政組卡片。**管理資料區另有：會議卡片、我的監察、批核中心、開戶、權限管理、車輛申請**（物資／泊車證／口頭報價／財務已併入相關卡片）。秘書處（譚健祥 Figo、何家耀 Oscar、陸詠德 Fiona、鄧倩姸 Cindy、曾凱瑩 Sandy，地域受薪職員）全為管理員，可跨組／為秘書處開戶。
4. **8 大卡片管理模組**：
